                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a class="btn btn-danger waves-effect waves-light" href="/sendDepositNotification/' . base64_encode($data->id) . '" target="_blank">' . trans("messages.Click here to send Notification") . '</a></td>
                                                </tr>
                                            </table>
                                        </div>
                                    </div>
