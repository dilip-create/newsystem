        ...
        <div class="container-fluid" >
            ...
            <div class="card">
                <div class="card-header border-0">
                    <div></div>
                    <div class="card-list">
                        <button type="button" class="btn btn-primary btn-rounded waves-effect waves-light" onclick="changeChart(60)"> {{__('messages.last 60 days')}} </button>
                        <button type="button" class="btn btn-primary btn-rounded waves-effect waves-light" onclick="changeChart(90)"> {{__('messages.last 90 days')}} </button>
                        <button type="button" class="btn btn-primary btn-rounded waves-effect waves-light" onclick="changeChart(180)"> {{__('messages.last 365 days')}} </button>
                    </div>
                </div>
                ...
                <div id="merchant-agent" style="font-size:12px;">
                    ...
                    {{-- <div class="table-responsive mt-2">
                        <table class="table dashboard" style="color:#fff;">
                            <tbody>
                                <tr>
                                    <td style="width: 25%; background-color:#808080; border: 1px solid lightgray" class="header-title">{{__('messages.Settlement Charges')}}</td>
                                    <td style="width: 25%; color:#000; border: 1px solid lightgray" class="header-title">
                                    ...
                                    <td style="width: 25%; background-color:#808080; border: 1px solid lightgray" class="header-title">{{__('messages.Day Allow to Settle')}}</td>
                                    <td style="width: 25%; color:#000; border: 1px solid lightgray" class="header-title">
                                        @if ($billing)
                                ...
                                <tr>
                                    <td style="width: 25%; background-color:#808080; border: 1px solid lightgray" class="header-title">{{__('messages.Daily Settlement Start Time')}}</td>
                                    <td style="width: 25%; color:#000; border: 1px solid lightgray" class="header-title">{{ date('h:i A', strtotime($billing?->withdrawal_start_time)) }}</td>
                                    <td style="width: 25%; background-color:#808080; border: 1px solid lightgray" class="header-title">{{__('messages.Settlement End Time')}}</td>
                                    <td style="width: 25%; color:#000; border: 1px solid lightgray" class="header-title">{{ date('h:i A', strtotime($billing?->withdrawal_end_time)) }}</td>
                                </tr>
                                <tr>
                                    <td style="width: 25%; background-color:#808080; border: 1px solid lightgray" class="header-title">{{__('messages.Min Amount')}}  / {{__('messages.Transaction')}}</td>
                                    <td style="width: 25%; color:#000; border: 1px solid lightgray" class="header-title">{{ $billing?->single_min_withdrawal }}</td>
                                    <td style="width: 25%; background-color:#808080; border: 1px solid lightgray" class="header-title">{{__('messages.Max Amount')}} / {{__('messages.Transaction')}}</td>
                                    <td style="width: 25%; color:#000; border: 1px solid lightgray" class="header-title">{{ $billing?->single_max_withdrawal }}</td>
                                </tr>
                                <tr>
                                    <td style="width: 25%; background-color:#808080; border: 1px solid lightgray" class="header-title">{{__('messages.Max settlement count per day')}}</td>
                                    <td style="width: 25%; color:#000; border: 1px solid lightgray" class="header-title">{{ $billing?->daily_withdrawals }}</td>
                                    <td style="width: 25%; background-color:#808080; border: 1px solid lightgray" class="header-title">{{__('messages.Max settlement amount per day')}}</td>
                                    <td style="width: 25%; color:#000; border: 1px solid lightgray" class="header-title">{{ $billing?->max_daily_withdrawals }}</td>
                                </tr>
                            </tbody>
                        </table>
                    </div> --}}
